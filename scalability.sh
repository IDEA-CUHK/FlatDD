...
/bin/time timeout 24h ./FlatDD --file ../../circuits/supremacy_n20.qasm -t 1
/bin/time timeout 24h ./FlatDD --file ../../circuits/supremacy_n20.qasm -t 2
/bin/time timeout 24h ./FlatDD --file ../../circuits/supremacy_n20.qasm -t 4
/bin/time timeout 24h ./FlatDD --file ../../circuits/supremacy_n20.qasm -t 8
/bin/time timeout 24h ./FlatDD --file ../../circuits/supremacy_n20.qasm -t 16

/bin/time ./qpp_qasm ../../circuits/supremacy_n20.qasm 1 ../../log/results/time/supremacy_n20_QPP.txt
/bin/time ./qpp_qasm ../../circuits/supremacy_n20.qasm 2 ../../log/results/time/supremacy_n20_QPP.txt
/bin/time ./qpp_qasm ../../circuits/supremacy_n20.qasm 4 ../../log/results/time/supremacy_n20_QPP.txt
/bin/time ./qpp_qasm ../../circuits/supremacy_n20.qasm 8 ../../log/results/time/supremacy_n20_QPP.txt
