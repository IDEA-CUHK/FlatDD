...
# /bin/time timeout 24h ./FlatDD --file ../../circuits/adder_n28.qasm -t 16
...
# /bin/time timeout 24h ./DDSIM --file ../../circuits/dnn_n20.qasm
# /bin/time timeout 24h ./DDSIM --file ../../circuits/dnn_n25.qasm
# /bin/time timeout 24h ./DDSIM --file ../../circuits/adder_n28.qasm
...
# /bin/time timeout 24h ./DDSIM --file ../../circuits/knn_n31.qasm
# /bin/time timeout 24h ./DDSIM --file ../../circuits/swap_test_n25.qasm
# /bin/time timeout 24h ./DDSIM --file ../../circuits/supremacy_n20.qasm
# /bin/time timeout 24h ./DDSIM --file ../../circuits/supremacy_n24.qasm
# /bin/time timeout 24h ./DDSIM --file ../../circuits/supremacy_n26.qasm

# cd ../../qpp/build
# /bin/time ./qpp_qasm ../../circuits/dnn_n16.qasm 16 ../../log/results/time/dnn_n16_QPP.txt
# /bin/time ./qpp_qasm ../../circuits/dnn_n20.qasm 16 ../../log/results/time/dnn_n20_QPP.txt
# /bin/time ./qpp_qasm ../../circuits/dnn_n25.qasm 16 ../../log/results/time/dnn_n25_QPP.txt
# /bin/time ./qpp_qasm ../../circuits/adder_n28.qasm 16 ../../log/results/time/adder_n28_QPP.txt
...
# /bin/time ./qpp_qasm ../../circuits/knn_n31.qasm 16 ../../log/results/time/knn_n31_QPP.txt
# /bin/time ./qpp_qasm ../../circuits/swap_test_n25.qasm 16 ../../log/results/time/swap_test_n25_QPP.txt
# /bin/time ./qpp_qasm ../../circuits/supremacy_n20.qasm 16 ../../log/results/time/supremacy_n20_QPP.txt
# /bin/time ./qpp_qasm ../../circuits/supremacy_n24.qasm 16 ../../log/results/time/supremacy_n24_QPP.txt
# /bin/time ./qpp_qasm ../../circuits/supremacy_n26.qasm 16 ../../log/results/time/supremacy_n26_QPP.txt